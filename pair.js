...
router.get('/', async (req, res) => {
    ...
    async function NETKING_MD_PAIR_CODE() {
        ...
        try {
            ...
            Pair_Code_By_Brasho_King.ev.on('creds.update', saveCreds);
            Pair_Code_By_Josh_King.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    await Pair_Code_By_Josh_King.sendMessage(Pair_Code_By_Josh_Kimg.user.id, {
                        ...
                        contextInfo: {
                            ...
                            externalAdReply: {
                                title: 'Thanks for choosing 𝗠𝗜𝗗𝗞𝗜𝗡𝗚𝗫 𝐌𝐃 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 happy deployment 💜',
                                body: 'Regards cαѕєчrhσdєѕ',
                                thumbnailUrl: 'https://files.catbox.moe/zyv7n7.jpg',
                    ...
                    await delay(100);
                    await Pair_Code_By_Josh_King.ws.close();
                    removeFile('./temp/' + id);
                } else if (connection === 'close' && lastDisconnect && lastDisconnect.error && lastDisconnect.error.output.statusCode !== 401) {
                    await delay(10000);
                    NETKING_MD_PAIR_CODE();
                }
            });
        } catch (err) {
